...
@section('title', 'Commercial Workspace')
...
<div class="container-fluid">
    ...
    <x-breadcrumb :items="[
        ['label' => 'Commercial', 'url' => route('commercial.dashboard')],
        ['label' => 'Workspace'],
    ]" />

    <div class="app-hero-card p-4 mb-4">
        <div class="d-flex align-items-center gap-3">
            <span class="app-stat-icon" style="width:48px;height:48px;border-radius:17px;font-size:20px;"><i class="bi bi-briefcase" aria-hidden="true"></i></span>
            <div>
                <div class="app-hero-eyebrow">Workspace</div>
                <h3 class="app-hero-title mb-1">Commercial Workspace</h3>
                <p class="app-hero-copy mb-0">Open uploaded files and update commercial related fields.</p>
            </div>
        </div>
    </div>
