...
<div class="container-fluid">
    ...
    <div class="app-hero-card p-4 mb-4">
        <div class="d-flex align-items-center gap-3">
            <span class="app-stat-icon" style="width:48px;height:48px;border-radius:17px;font-size:20px;"><i class="bi bi-truck" aria-hidden="true"></i></span>
            <div>
                <div class="app-hero-eyebrow">Workspace</div>
                <h3 class="app-hero-title mb-1">Supply Chain Workspace</h3>
                <p class="app-hero-copy mb-0">Open uploaded files and update supply chain related fields.</p>
            </div>
        </div>
    </div>
