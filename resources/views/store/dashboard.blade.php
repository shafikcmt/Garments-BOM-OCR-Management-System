        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="app-hero-copy mb-0">Track store-side files and OCR records.</p>
                </div>
            </div>
            <a href="{{ route('store.workspace') }}" class="btn btn-primary px-4 d-inline-flex align-items-center gap-2">
