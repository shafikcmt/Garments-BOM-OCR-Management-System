...
@section('title', 'Edit Delivery Destination')
...
<div class="container-fluid">
    <x-breadcrumb :items="[
        ...
        ['label' => 'Booking Setup'],
        ['label' => 'Edit Delivery Destination'],
    ]" />
        ...
        <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h3 class="app-hero-title mb-0">Edit Delivery Destination</h3>
                </div>
            </div>
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('admin.booking-delivery-destinations.update', $destination) }}">
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-primary px-4"><i class="bi bi-save me-1" aria-hidden="true"></i>Update Destination</button>
