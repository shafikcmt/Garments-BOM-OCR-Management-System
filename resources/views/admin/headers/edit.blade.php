...
<div class="container-fluid py-2 px-2 px-md-3 header-form-page">
    <div class="hero-card mb-3">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
            <div>
                <h3 class="hero-title">Edit Header</h3>
                <p class="hero-text">Existing header configuration update korun. Value mode, formula key, access flag sob ekhane manage korte parben.</p>
            </div>
    ...
    <div class="card form-shell border-0">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.headers.update', $header->id) }}">
                @csrf
                @method('PUT')
