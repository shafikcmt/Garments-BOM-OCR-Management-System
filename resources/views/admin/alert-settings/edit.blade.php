...
<div class="container-fluid">
    <x-breadcrumb :items="[
        ...
        ['label' => 'Settings'],
        ['label' => 'PI Missing Alert Settings'],
    ]" />

    <div class="app-hero-card p-4 mb-4">
        <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
            <div class="d-flex align-items-center gap-3">
                <span class="app-stat-icon" style="width:46px;height:46px;border-radius:15px;font-size:20px;"><i class="bi bi-bell" aria-hidden="true"></i></span>
                <div>
