    ...
    <div class="app-hero-card p-4 p-lg-5 mb-4">
        <div class="app-hero-layout d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div class="app-hero-main d-flex align-items-center gap-3">
                <span class="app-stat-icon" style="width:52px;height:52px;border-radius:18px;font-size:22px;"><i class="bi bi-cash-stack"></i></span>
                <div>
                    <div class="app-hero-eyebrow">Account</div>
                    <h2 class="app-hero-title">Welcome, {{ auth()->user()->name }}</h2>
                    <p class="app-hero-copy mb-0">Review account-side OCR workflow and file updates.</p>
                </div>
            </div>
            <a href="{{ route('account.workspace') }}" class="app-hero-action btn btn-primary px-4 d-inline-flex align-items-center gap-2">
