...
// Buyer/Style module (module B) — movements OUT of Liability stock (Excel
// "Liability Issuing" sheet). Liability is never lost: it is either transferred
// back to Bulk (reused in production) or issued as sample.
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('material_liability_movements', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('material_liability_movements');
    }
};
